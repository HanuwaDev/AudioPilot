...
namespace AudioPilot.ViewModels
{
    public partial class AppViewModel
    {
        ...
        public async Task<string> GetNetworkListFromCliAsync(bool jsonOutput)
        {
            try
            {
        ...
        public string GetNetworkListFromCli(bool jsonOutput)
        {
            return GetNetworkListFromCliAsync(jsonOutput).GetAwaiter().GetResult();
        }
