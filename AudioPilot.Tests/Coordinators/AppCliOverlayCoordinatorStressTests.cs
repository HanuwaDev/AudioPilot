...
{
    [StressFact]
    public async Task MediaNextTrack_RepeatedStaleCaptureCycles_SuppressOverlayWithoutGettingStuck_WhenStressEnabled()
    {
        if (!TestExecutionGuards.RequireStressEnabled(nameof(MediaNextTrack_RepeatedStaleCaptureCycles_SuppressOverlayWithoutGettingStuck_WhenStressEnabled)))
        {
            return;
        }
    ...
    [StressFact]
    public async Task MixedMediaCommandBurst_WhenCaptureIsStale_SuppressesOverlayAcrossCommandTypes_WhenStressEnabled()
    {
        if (!TestExecutionGuards.RequireStressEnabled(nameof(MixedMediaCommandBurst_WhenCaptureIsStale_SuppressesOverlayAcrossCommandTypes_WhenStressEnabled)))
        {
            return;
        }
