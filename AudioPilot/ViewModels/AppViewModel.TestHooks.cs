...
namespace AudioPilot.ViewModels
{
    public partial class AppViewModel
    {
        ...
        internal bool TryClaimRoutineAppStartMatchForTests(string? routineId, int processId, RoutineAppStartProcessSnapshot processSnapshot)
            => TryClaimRoutineAppStartMatch(routineId, processId, processSnapshot);
        ...
        private static AudioRoutine CloneRoutineForTests(AudioRoutine routine)
        {
            return new AudioRoutine
            {
                ...
                TriggerOnAppStart = routine.TriggerOnAppStart,
