...
namespace AudioPilot.Services.Audio
{
    public class AudioSessionService : IDisposable
    {
        ...
        internal void RecordEndpointVolumeNotification(AudioMixerMode mixerMode, float volumePercent, bool isMuted)
        {
            _recentSnapshotCache.RecordEndpointVolumeNotification(mixerMode, volumePercent, isMuted);
        }
