...
public sealed class CliCommandExecutorTests
{
    ...
    private sealed class FileBackedConfigRuntime(Settings settings) : ICliCommandRuntime
    {
        ...
        public (bool Success, string Output) ExportDiagnosticBundle(string path, bool allowAnyPath, CliDiagnosticsExportDetailLevel detailLevel, bool includeSensitive, bool jsonOutput) => (true, "bundle-exported");
        ...
        public string GetNetworkList(bool jsonOutput, bool redactOutput) => jsonOutput ? "{\"Success\":true,\"Count\":0,\"Networks\":[]}" : "No networks detected.";
