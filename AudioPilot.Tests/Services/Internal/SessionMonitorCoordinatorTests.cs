...
public sealed class SessionMonitorCoordinatorTests
{
    ...
    public async Task Update_AttachesAllActiveEndpoints_ForOutputAndInput()
    {
        ...
        var outputCoordinator = CreateCoordinator(
            ...
            onEndpointVolumeChanged: (mixerMode, endpointId, volumePercent) => outputEndpointVolumes.Add((mixerMode, endpointId, volumePercent)),
        ...
        var inputCoordinator = CreateCoordinator(
            ...
            onEndpointVolumeChanged: (mixerMode, endpointId, volumePercent) => inputEndpointVolumes.Add((mixerMode, endpointId, volumePercent)),
    ...
    public async Task StopThenRestart_WithReusedEndpointAndSessionId_IgnoresStaleSessionAndEndpointCallbacks()
    {
        ...
        var coordinator = CreateCoordinator(
            ...
            onEndpointVolumeChanged: (mixerMode, endpointId, volumePercent) => endpointVolumes.Add((mixerMode, endpointId, volumePercent)),
    ...
    private static SessionMonitorCoordinator CreateCoordinator(
        ...
        Action<AudioMixerMode, string, float>? onEndpointVolumeChanged = null,
        ...
        AudioMixerMode mixerMode = AudioMixerMode.Output)
    {
        ...
        Action<AudioMixerMode, string, float> endpointVolumeHandler = onEndpointVolumeChanged ?? ((_, _, _) => { });
    ...
    private sealed class StubAudioSessionControl2(string sessionInstanceId, Action? onUnregister = null) : IAudioSessionControl2
    {
