...
public sealed class SettingsValidationServiceTests
{
    ...
    [Fact]
    public void EvaluateDiagnostics_ReportsMissingDeviceTarget_ForVolumeOnlyRoutineTargets()
    {
        var settings = new Settings
        {
            Routines = new RoutinesSettings
        ...
        Assert.Contains(diagnostics.Warnings, warning => warning.Code == "invalid-routine-target-0");
    }
