    ...
    public static partial class CliCommandExecutor
    {
        private static async Task<CliExecutionResult> ExecuteRoutinesAndDiagnosticsAsync(CliCommand command, ICliCommandRuntime runtime)
        {
            return command.Action switch
            {
                ...
                CliAction.DiagnosticsExportBundle => ExecuteDiagnosticsBundleExport(command, runtime),
        ...
        private static CliExecutionResult ExecuteDiagnosticsBundleExport(CliCommand command, ICliCommandRuntime runtime)
        {
            if (string.IsNullOrWhiteSpace(command.Key))
            {
            ...
            var (success, output) = runtime.ExportDiagnosticBundle(
                command.Key,
