...
public sealed class AudioSessionServiceTests
{
    ...
    public void RecordEndpointVolumeNotification_UpdatesCachedEndpointEntries()
    {
        ...
        service.SeedEndpointSnapshotForTests(
            ...
            CreateEndpointSnapshotEntry("playback-1", "Playback", 50f));
        service.SeedEndpointSnapshotForTests(
            AudioMixerMode.Input,
            CreateEndpointSnapshotEntry("recording-1", "Recording", 25f));

        service.RecordEndpointVolumeNotification(AudioMixerMode.Output, 61f);
        service.RecordEndpointVolumeNotification(AudioMixerMode.Input, 37f);
    ...
    public void InvalidateRecentMixerSnapshotState_ClearsRecentTopologyStateOnly()
    {
        ...
        service.SeedRecentSnapshotForTests(AudioMixerMode.Output, cachedSnapshots, DateTime.UtcNow);
        service.SeedRecentSnapshotForTests(AudioMixerMode.Input, cachedSnapshots, DateTime.UtcNow);
        service.SeedEndpointSnapshotForTests(AudioMixerMode.Output, CreateEndpointSnapshotEntry("playback-1", "Playback", 50f));
        service.SeedEndpointSnapshotForTests(AudioMixerMode.Input, CreateEndpointSnapshotEntry("recording-1", "Recording", 25f));
