...
public sealed class AppRoutineStatefulCoordinatorTests
{
    ...
    public void CreateSession_BuildsStableSessionIdentity()
    {
        ...
        Assert.Equal("app-start:routine-1:321", session.SessionKey);
    ...
    public void GetEndedAppStartSessionKeys_ReturnsNewestEndedSessionsFirst()
    {
        ...
        {
            ["app-start:routine-a:100"] = new("app-start:routine-a:100", "routine-a", "A", RoutineTriggerKind.AppStartup, 1, true, null, 100),
            ["app-start:routine-b:200"] = new("app-start:routine-b:200", "routine-b", "B", RoutineTriggerKind.AppStartup, 3, true, null, 200),
        ...
        Assert.Equal(["app-start:routine-b:200"], ended);
    }
    ...
    public void DeactivateSession_RemovesTargetAndRequestsRestoreOnlyForLatestRestorableSession()
    {
        Dictionary<string, AppViewModel.RoutineStatefulSession> sessions = new(StringComparer.OrdinalIgnoreCase)
        {
            ["app-start:routine-old:100"] = new("app-start:routine-old:100", "routine-old", "Old", RoutineTriggerKind.AppStartup, 1, true, null, 100),
            ["app-start:routine-new:200"] = new("app-start:routine-new:200", "routine-new", "New", RoutineTriggerKind.AppStartup, 2, true, null, 200),
        };

        RoutineStatefulSessionDeactivationResult oldResult = AppRoutineStatefulCoordinator.DeactivateSession(sessions, "app-start:routine-old:100");
        RoutineStatefulSessionDeactivationResult newResult = AppRoutineStatefulCoordinator.DeactivateSession(sessions, "app-start:routine-new:200");
    ...
    public void GetInvalidRoutineStatefulSessionKeys_KeepsStillWatchedSessions()
    {
        Dictionary<string, AppViewModel.RoutineStatefulSession> activeSessions = new(StringComparer.OrdinalIgnoreCase)
        {
            ["app-start:routine-a:100"] = new("app-start:routine-a:100", "routine-a", "Routine A", RoutineTriggerKind.AppStartup, 1, true, null, 100),
